...
public class NetworkVolei extends AsyncTask<URL, Void, String> {



    public static ArrayList<MeciVolei> mVolei;
        ...
        if (jsonStr != null){
            try {
                ...
                for(int i=0;i<jsonArray.length();i++)
                {
                    ...
                    MeciVolei m = new MeciVolei(id,object.getString("team1"),
