...
public class MeciFotbal extends Meci{
    ...
    public MeciFotbal(int id,String team1, String team2, String type, String league, String date, String time, int cod_img1, int cod_img2) {
    ...
    public MeciFotbal(int id,String team1, String team2, String type, String league, String date, String time, int cod_img1, int cod_img2,int scor1,int scor2) {
        super(team1, team2, type, league, date);
        this.time = time;
        this.cod_img1 = cod_img1;
        this.cod_img2 = cod_img2;
