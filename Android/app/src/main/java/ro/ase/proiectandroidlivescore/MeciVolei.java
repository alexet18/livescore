...
public class MeciVolei extends Meci{
   ...
   private int id,cod_img1,cod_img2,scor1,scor2;
    ...
    public MeciVolei(int id,String team1, String team2, String type, String league, String date,String time,int cod_img1,int cod_img2) {
    ...
    public MeciVolei(String team1, String team2, String type, String league, String date,String time,int cod_img1,int cod_img2) {
    ...
    public MeciVolei(int id,String team1, String team2, String type, String league, String date,String time,int cod_img1,int cod_img2,int scor1,int scor2) {
